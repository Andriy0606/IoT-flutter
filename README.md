...
#### 4.0.1.Екстра налаштування:
Для моєї і вашої зручності, необхідно також налаштувати міні пайплайн для перевірки коду.
Я прикріпляю  validation.yaml файлик який призначений для валідації вашого коду, автоматично як ви зробите ПР
Добавити його треба наступним чином: 

* Робите в корені проекту папку `.github`
* далі заходите туди і створюєте ще папку `workflows`
* Вже в середині цієї папки робите файлик `validation.yaml`
* Копієюєте вміст з файлу `validation.yaml` у цьому репозиторії, і переносите його у ваш файл
